...
const translations = {
    he: {
        ...
        cal_save: 'שמור',
        cal_remove: 'הסר',
        weekly_title: 'היעדרויות לשבוע הקרוב',
        cal_from: 'מתאריך',
        cal_to: 'עד תאריך',
        cal_days: 'ימים',
        cal_date_error: 'תאריך סיום חייב להיות אחרי תאריך התחלה',
        cal_saved: 'עודכן בהצלחה',
        cal_removed: 'ההיעדרות הוסרה',
        // Admin / Permissions
        btn_admin: 'הרשאות',
        admin_title: 'ניהול והרשאות',
        admin_participants_title: 'ניהול משתתפים',
        admin_participants_hint: 'הוספה והסרה של עובדים מהמערכת',
        admin_add_participant_ph: 'שם משתתף חדש...',
        admin_add_participant_btn: 'הוסף משתתף',
        admin_remove_participant: 'הסר משתתף',
        admin_no_participants: 'אין משתתפים',
        admin_participant_added: 'המשתתף נוסף בהצלחה',
        admin_participant_removed: 'המשתתף הוסר',
        admin_participant_exists: 'המשתתף כבר קיים',
        admin_participant_empty: 'יש להזין שם',
        admin_confirm_remove: 'להסיר את המשתתף מהמערכת?',
        admin_no_permission: 'אין לך הרשאת ניהול',
        admin_tasks_title: 'ניהול משימות',
        admin_tasks_hint: 'כמנהל יש לך שליטה מלאה: הוספה, עריכה ומחיקה של כל משימה בטבלה.',
        admin_tasks_total: 'סה"כ משימות במערכת',
        admin_delete_all_tasks: 'מחק את כל המשימות',
        admin_confirm_delete_all: 'אזהרה! פעולה זו תמחק את כל המשימות במערכת ואינה ניתנת לביטול. להמשיך?',
        admin_all_tasks_deleted: 'כל המשימות נמחקו',
    },
    ...
    en: {
        ...
        cal_save: 'Save',
        cal_remove: 'Remove',
        weekly_title: 'Absences this week',
        cal_from: 'From date',
        cal_to: 'To date',
        cal_days: 'days',
        cal_date_error: 'End date must be after start date',
        cal_saved: 'Updated successfully',
        cal_removed: 'Absence removed',
        // Admin / Permissions
        btn_admin: 'Permissions',
        admin_title: 'Management & Permissions',
        admin_participants_title: 'Manage Participants',
        admin_participants_hint: 'Add or remove workers from the system',
        admin_add_participant_ph: 'New participant name...',
        admin_add_participant_btn: 'Add participant',
        admin_remove_participant: 'Remove participant',
        admin_no_participants: 'No participants',
        admin_participant_added: 'Participant added successfully',
        admin_participant_removed: 'Participant removed',
        admin_participant_exists: 'Participant already exists',
        admin_participant_empty: 'Please enter a name',
        admin_confirm_remove: 'Remove this participant from the system?',
        admin_no_permission: 'You do not have management permission',
        admin_tasks_title: 'Manage Tasks',
        admin_tasks_hint: 'As an admin you have full control: add, edit and delete any task in the table.',
        admin_tasks_total: 'Total tasks in system',
        admin_delete_all_tasks: 'Delete all tasks',
        admin_confirm_delete_all: 'Warning! This will delete ALL tasks in the system and cannot be undone. Continue?',
        admin_all_tasks_deleted: 'All tasks deleted',
    },
    ...
    ru: {
        ...
        cal_save: 'Сохранить',
        cal_remove: 'Удалить',
        weekly_title: 'Отсутствия на этой неделе',
        cal_from: 'С даты',
        cal_to: 'По дату',
        cal_days: 'дней',
        cal_date_error: 'Дата окончания должна быть позже даты начала',
        cal_saved: 'Успешно обновлено',
        cal_removed: 'Отсутствие удалено',
        // Admin / Permissions
        btn_admin: 'Права',
        admin_title: 'Управление и права',
        admin_participants_title: 'Управление участниками',
        admin_participants_hint: 'Добавление и удаление работников из системы',
        admin_add_participant_ph: 'Имя нового участника...',
        admin_add_participant_btn: 'Добавить участника',
        admin_remove_participant: 'Удалить участника',
        admin_no_participants: 'Нет участников',
        admin_participant_added: 'Участник успешно добавлен',
        admin_participant_removed: 'Участник удалён',
        admin_participant_exists: 'Участник уже существует',
        admin_participant_empty: 'Введите имя',
        admin_confirm_remove: 'Удалить этого участника из системы?',
        admin_no_permission: 'У вас нет прав управления',
        admin_tasks_title: 'Управление задачами',
        admin_tasks_hint: 'Как администратор вы полностью контролируете: добавление, редактирование и удаление любой задачи.',
        admin_tasks_total: 'Всего задач в системе',
        admin_delete_all_tasks: 'Удалить все задачи',
        admin_confirm_delete_all: 'Внимание! Это удалит ВСЕ задачи в системе без возможности отмены. Продолжить?',
        admin_all_tasks_deleted: 'Все задачи удалены',
    },
    ...
    am: {
        ...
        cal_save: 'አስቀምጥ',
        cal_remove: 'አስወግድ',
        weekly_title: 'በዚህ ሳምንት ቀሪዎች',
        cal_from: 'ከቀን',
        cal_to: 'እስከ ቀን',
        cal_days: 'ቀናት',
        cal_date_error: 'የማብቂያ ቀን ከመጀመሪያ ቀን በኋላ መሆን አለበት',
        cal_saved: 'በተሳካ ሁኔታ ተዘምኗል',
        cal_removed: 'ቀሪው ተወግዷል',
        // Admin / Permissions
        btn_admin: 'ፍቃዶች',
        admin_title: 'አስተዳደር እና ፍቃዶች',
        admin_participants_title: 'ተሳታፊዎችን ማስተዳደር',
        admin_participants_hint: 'ሠራተኞችን ከስርዓቱ ማከል ወይም ማስወገድ',
        admin_add_participant_ph: 'የአዲስ ተሳታፊ ስም...',
        admin_add_participant_btn: 'ተሳታፊ ጨምር',
        admin_remove_participant: 'ተሳታፊ አስወግድ',
        admin_no_participants: 'ተሳታፊዎች የሉም',
        admin_participant_added: 'ተሳታፊ በተሳካ ሁኔታ ታክሏል',
        admin_participant_removed: 'ተሳታፊ ተወግዷል',
        admin_participant_exists: 'ተሳታፊው አስቀድሞ አለ',
        admin_participant_empty: 'እባክዎ ስም ያስገቡ',
        admin_confirm_remove: 'ይህን ተሳታፊ ከስርዓቱ ማስወገድ?',
        admin_no_permission: 'የአስተዳደር ፍቃድ የለዎትም',
        admin_tasks_title: 'ተግባራትን ማስተዳደር',
        admin_tasks_hint: 'እንደ አስተዳዳሪ ሙሉ ቁጥጥር አለዎት፦ ማንኛውንም ተግባር መጨመር፣ ማረም እና መሰረዝ።',
        admin_tasks_total: 'በስርዓቱ ውስጥ ጠቅላላ ተግባራት',
        admin_delete_all_tasks: 'ሁሉንም ተግባራት ሰርዝ',
        admin_confirm_delete_all: 'ማስጠንቀቂያ! ይህ ሁሉንም ተግባራት ይሰርዛል እና መመለስ አይቻልም። ይቀጥሉ?',
        admin_all_tasks_deleted: 'ሁሉም ተግባራት ተሰርዘዋል'
    }
};
